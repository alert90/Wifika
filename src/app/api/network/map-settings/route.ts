    ...
    if (!settings) {
      ...
      settings = await prisma.mapSettings.create({
        data: {
          ...
          defaultLat: defaultLat !== undefined ? parseFloat(defaultLat) : -6.7924,
          defaultLon: defaultLon !== undefined ? parseFloat(defaultLon) : 39.2083,
          defaultZoom: defaultZoom !== undefined ? parseInt(defaultZoom) : 12,
